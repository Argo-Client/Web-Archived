...
export function NavbarItem({ children, href, Icon }: { children: string; href: string; Icon: IconType }) {
	return (
		<Link href={href}>
			<a>
				<div className="px-5 py-2 mx-2 rounded-md text-gray-600 dark:text-white hover:bg-gray-200 dark:hover:bg-dark-tertiary flex items-center">
...
export function IconButton({ Icon, small, className = "", ...props }: IconButton) {
	return (
		<button className={`mr-3 focus:outline-none bg-gray-200 p-1 dark:bg-dark-tertiary rounded-full shadow-md ${className}`} {...props}>
